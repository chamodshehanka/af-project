    ...
    <div>
       <Grid xs={8}>
         ...
         <Grid item xs={12}style={{marginLeft:'30px', marginRight:'30px', padding:'10px'}}>
             <Typography variant="h5"  align="left" color="textSecondary" gutterBottom>Add Product Details</Typography>
         </Grid>
           ...
           <Grid container spacing={3}>
             <Grid item xs={12} style={{marginLeft:'30px', marginRight:'30px'}}>
              ...
              <Grid item xs={12} style={{marginLeft:'30px', marginRight:'30px'}}>
               ...
               <Grid item xs={12} sm={6}>
                  <Button type="submit" variant="outlined" color="secondary">Add Product</Button>
               </Grid>  
             </Grid>
            </form>
         </Paper>
