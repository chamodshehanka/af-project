      ...
      <Grid xs={8}>
        <Paper style={{height:'320px'}}>
          <Grid item xs={12} style={{marginLeft:'30px', marginRight:'30px', padding:'10px'}}>
              <Typography variant="h5"  align="left" color="textSecondary" gutterBottom>Delete Products</Typography>
          </Grid>
          <form noValidate onSubmit={handleSubmit(onSubmit)}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} style={{marginLeft:'30px', marginRight:'30px'}}>
                <Typography align="left" color="textSecondary" variant="h6"></Typography>
              </Grid>
    
              <Grid item xs={12} align="left" style={{marginLeft:'30px', marginRight:'30px'}}>
                  <Button type="submit" variant="outlined" color="secondary">Delete Product</Button>
              </Grid>
            </Grid>
          </form>
        </Paper>  
